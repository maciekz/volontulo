...
urlpatterns = [  # pylint: disable=invalid-name
    ...
    url(r'^api/offers/create/', api_views.OfferCreateView.as_view(),
        name='offer-create'),
    url(r'^api/offers/(?P<pk>[0-9]+)/update',
        api_views.OfferUpdateView.as_view(), name='offer-update'),
    url(r'^api/offers/(?P<pk>[0-9]+)/join',
        api_views.OfferJoinView.as_view(), name='offer-join'),
    ...
    url(r'api/organizations/(?P<pk>[0-9]+)/users',
        api_views.OrganizationUsersViewSet.as_view({'get': 'list'}),
